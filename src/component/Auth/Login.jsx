      ...
      <div className='border-2 border-red-600 p-20'>
        ...
        className='flex flex-col item-center justify-center'>
          ...
          setEmail(e.target.value)
           ...
           required className='border-2 border-emerald-600 text-xl rounded-full py-4 px-5' type='email' placeholder='Enter Your Email' />
          <input
          value={password}
          onChange={(e)=>{
            setPassword(e.target.value)
          }}
          required className='border-2 border-emerald-600 text-xl rounded-full py-4 px-5' type='password' placeholder=' Enter Your password' />
